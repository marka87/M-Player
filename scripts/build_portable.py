...
def run_pyinstaller():
    ...
    pyinstaller_args = [
        ...
        "--hidden-import=src.services.downloader",
        "--hidden-import=src.services.metadata",
        "--hidden-import=src.services.cover_enricher",
        "--hidden-import=src.services.recommendations",
        "--hidden-import=src.translations",
        "--hidden-import=src.translations.i18n",
        "--hidden-import=src.ui",
        "--hidden-import=src.ui.ui",
        "--hidden-import=src.ui.mini_player",
